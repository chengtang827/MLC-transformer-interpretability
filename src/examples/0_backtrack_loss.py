...
"""
iteratively ablate attention heads, and check which ablation results in the largest increase in cross-entropy loss.
This only works for the first step from unembedding because of redundancy in the decoder.
"""
if __name__ == "__main__":
        ...
        # set n_track=0 to disable recursive tracking
        circuit = backtrack_analyzer.back_track(arg_output=[0,1,2], plot_score=1, metric='loss', n_track=0, keep_one_only=0)
